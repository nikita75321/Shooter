...
//             if (IsDebug) Debug.Log("WebSocket GL connected!");
//         };
...
//         {
//             //GameManager.Instance.Analytics.SendEvent($"SocketError_{errMsg}", true);
...
//             if(IsDebug)  Debug.Log($"Raw received message ({message.Length} bytes): {json}");
...
//         catch (Exception ex) 
//         {
//             //GameManager.Instance.Analytics.SendEvent($"ResponseMessageError_{ex}", true);
